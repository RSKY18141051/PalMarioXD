...
namespace Sintaxis3
{
    class Lexico: Token, IDisposable
    {
        ...
        public Lexico()
        {
            ...
            if (File.Exists("C:\\Archivos C#\\Prueba.cpp"))
            {
                archivo = new StreamReader("C:\\Archivos C#\\Prueba.cpp");
                bitacora = new StreamWriter("C:\\Archivos C#\\Prueba.log");
                bitacora.AutoFlush = true;

                DateTime fechaActual = DateTime.Now;

                bitacora.WriteLine("Archivo: prueba.cpp");
                bitacora.WriteLine("Directorio: C:\\Archivos C#");
